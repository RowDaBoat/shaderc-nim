...
type
  EnumSourceLanguage_536871498* {.size: sizeof(cuint).} = enum
    glsl = 0, hlsl = 1
type
  EnumShaderKind_536871503* {.size: sizeof(cuint).} = enum
...
when not declared(glslVertexShader):
  const
    glslVertexShader* = EnumShaderKind_536871503.vertexShader
else:
  static :
...
when not declared(glslFragmentShader):
  const
    glslFragmentShader* = EnumShaderKind_536871503.fragmentShader
else:
  static :
...
when not declared(glslComputeShader):
  const
    glslComputeShader* = EnumShaderKind_536871503.computeShader
else:
  static :
...
when not declared(glslGeometryShader):
  const
    glslGeometryShader* = EnumShaderKind_536871503.geometryShader
else:
  static :
...
when not declared(glslTessControlShader):
  const
    glslTessControlShader* = EnumShaderKind_536871503.tessControlShader
else:
  static :
...
when not declared(glslTessEvaluationShader):
  const
    glslTessEvaluationShader* = EnumShaderKind_536871503.tessEvaluationShader
else:
  static :
...
when not declared(glslRaygenShader):
  const
    glslRaygenShader* = EnumShaderKind_536871503.raygenShader
else:
  static :
...
when not declared(glslAnyhitShader):
  const
    glslAnyhitShader* = EnumShaderKind_536871503.anyhitShader
else:
  static :
...
when not declared(glslClosesthitShader):
  const
    glslClosesthitShader* = EnumShaderKind_536871503.closesthitShader
else:
  static :
...
when not declared(glslMissShader):
  const
    glslMissShader* = EnumShaderKind_536871503.missShader
else:
  static :
...
when not declared(glslIntersectionShader):
  const
    glslIntersectionShader* = EnumShaderKind_536871503.intersectionShader
else:
  static :
...
when not declared(glslCallableShader):
  const
    glslCallableShader* = EnumShaderKind_536871503.callableShader
else:
  static :
...
when not declared(glslTaskShader):
  const
    glslTaskShader* = EnumShaderKind_536871503.taskShader
else:
  static :
...
when not declared(glslMeshShader):
  const
    glslMeshShader* = EnumShaderKind_536871503.meshShader
else:
  static :
    hint("Declaration of " & "glslMeshShader" &
        " already exists, not redeclaring")
type
  EnumProfile_536871507* {.size: sizeof(cuint).} = enum
    none = 0, core = 1, compatibility = 2, es = 3
type
  EnumOptimizationLevel_536871511* {.size: sizeof(cuint).} = enum
    zero = 0, size = 1, performance = 2
type
  EnumLimit_536871515* {.size: sizeof(cuint).} = enum
...
type
  EnumUniformKind_536871519* {.size: sizeof(cuint).} = enum
    image = 0, sampler = 1, texture = 2, buffer = 3, storageBuffer = 4,
    unorderedAccessView = 5
type
  EnumIncludeType_536871531* {.size: sizeof(cuint).} = enum
    relative = 0, standard = 1
type
  EnumTargetEnv_536871545* {.size: sizeof(cuint).} = enum
    vulkan = 0, opengl = 1, openglCompat = 2, webgpu = 3
when not declared(default):
  const
    default* = EnumTargetEnv_536871545.vulkan
else:
  static :
    hint("Declaration of " & "default" & " already exists, not redeclaring")
type
  EnumSpirvVersion_536871547* {.size: sizeof(cuint).} = enum
...
type
  EnumCompilationStatus_536871549* {.size: sizeof(cuint).} = enum
...
when not declared(StructCompiler):
  ...
  static :
    hint("Declaration of " & "StructCompiler" &
        " already exists, not redeclaring")
type
  SourceLanguage_536871501 = EnumSourceLanguage_536871500 ## Generated based on /Users/row/projects/shaderc-nim/shaderc/libshaderc/include/shaderc/shaderc.h:34:3
  ShaderKind_536871505 = EnumShaderKind_536871504 ## Generated based on /Users/row/projects/shaderc-nim/shaderc/libshaderc/include/shaderc/shaderc.h:90:3
  Profile_536871509 = EnumProfile_536871508 ## Generated based on /Users/row/projects/shaderc-nim/shaderc/libshaderc/include/shaderc/shaderc.h:98:3
  OptimizationLevel_536871513 = EnumOptimizationLevel_536871512 ## Generated based on /Users/row/projects/shaderc-nim/shaderc/libshaderc/include/shaderc/shaderc.h:105:3
  Limit_536871517 = EnumLimit_536871516 ## Generated based on /Users/row/projects/shaderc-nim/shaderc/libshaderc/include/shaderc/shaderc.h:211:3
  UniformKind_536871521 = EnumUniformKind_536871520 ## Generated based on /Users/row/projects/shaderc-nim/shaderc/libshaderc/include/shaderc/shaderc.h:230:3
  CompilerT_536871523 = ptr StructCompiler ## Generated based on /Users/row/projects/shaderc-nim/shaderc/libshaderc/include/shaderc/shaderc.h:257:34
  CompileOptionsT_536871525 = ptr StructCompileOptions ## Generated based on /Users/row/projects/shaderc-nim/shaderc/libshaderc/include/shaderc/shaderc.h:277:41
  StructIncludeResult_536871527 {.pure, inheritable, bycopy.} = object
    ...
    userData*: pointer
  IncludeResult_536871529 = StructIncludeResult_536871528 ## Generated based on /Users/row/projects/shaderc-nim/shaderc/libshaderc/include/shaderc/shaderc.h:359:3
  IncludeResolveFn_536871533 = proc (a0: pointer; a1: cstring; a2: cint;
                                     a3: cstring; a4: csize_t): ptr IncludeResult_536871530 {.
      cdecl.}                ## Generated based on /Users/row/projects/shaderc-nim/shaderc/libshaderc/include/shaderc/shaderc.h:375:35
  IncludeResultReleaseFn_536871535 = proc (a0: pointer; a1: ptr IncludeResult_536871530): void {.
      cdecl.}                ## Generated based on /Users/row/projects/shaderc-nim/shaderc/libshaderc/include/shaderc/shaderc.h:380:16
  TargetEnv_536871537 = EnumTargetEnv_536871546 ## Generated based on /usr/local/include/shaderc/env.h:35:3
  SpirvVersion_536871539 = EnumSpirvVersion_536871548 ## Generated based on /usr/local/include/shaderc/env.h:66:3
  CompilationResultT_536871541 = ptr StructCompilationResult ## Generated based on /Users/row/projects/shaderc-nim/shaderc/libshaderc/include/shaderc/shaderc.h:511:44
  CompilationStatus_536871543 = EnumCompilationStatus_536871550 ## Generated based on /usr/local/include/shaderc/status.h:33:3
  Limit_536871518 = (when declared(Limit):
    when ownSizeof(Limit) != ownSizeof(Limit_536871517):
      static :
        warning("Declaration of " & "Limit" & " exists but with different size")
    Limit
  else:
    Limit_536871517)
  CompilerT_536871524 = (when declared(CompilerT):
    when ownSizeof(CompilerT) != ownSizeof(CompilerT_536871523):
      static :
    ...
    CompilerT_536871523)
  CompilationStatus_536871544 = (when declared(CompilationStatus):
    when ownSizeof(CompilationStatus) != ownSizeof(CompilationStatus_536871543):
      static :
        warning("Declaration of " & "CompilationStatus" &
            " exists but with different size")
    CompilationStatus
  else:
    CompilationStatus_536871543)
  UniformKind_536871522 = (when declared(UniformKind):
    when ownSizeof(UniformKind) != ownSizeof(UniformKind_536871521):
      static :
        warning("Declaration of " & "UniformKind" &
            " exists but with different size")
    UniformKind
  else:
    UniformKind_536871521)
  IncludeResolveFn_536871534 = (when declared(IncludeResolveFn):
    when ownSizeof(IncludeResolveFn) != ownSizeof(IncludeResolveFn_536871533):
      static :
        warning("Declaration of " & "IncludeResolveFn" &
            " exists but with different size")
    IncludeResolveFn
  else:
    IncludeResolveFn_536871533)
  EnumOptimizationLevel_536871512 = (when declared(EnumOptimizationLevel):
    when ownSizeof(EnumOptimizationLevel) != ownSizeof(EnumOptimizationLevel_536871511):
      static :
        warning("Declaration of " & "EnumOptimizationLevel" &
            " exists but with different size")
    EnumOptimizationLevel
  else:
    EnumOptimizationLevel_536871511)
  IncludeResultReleaseFn_536871536 = (when declared(IncludeResultReleaseFn):
    when ownSizeof(IncludeResultReleaseFn) != ownSizeof(IncludeResultReleaseFn_536871535):
      static :
        warning("Declaration of " & "IncludeResultReleaseFn" &
            " exists but with different size")
    IncludeResultReleaseFn
  else:
    IncludeResultReleaseFn_536871535)
  SourceLanguage_536871502 = (when declared(SourceLanguage):
    when ownSizeof(SourceLanguage) != ownSizeof(SourceLanguage_536871501):
      static :
        warning("Declaration of " & "SourceLanguage" &
            " exists but with different size")
    SourceLanguage
  else:
    SourceLanguage_536871501)
  EnumIncludeType_536871532 = (when declared(EnumIncludeType):
    when ownSizeof(EnumIncludeType) != ownSizeof(EnumIncludeType_536871531):
      static :
        warning("Declaration of " & "EnumIncludeType" &
            " exists but with different size")
    EnumIncludeType
  else:
    EnumIncludeType_536871531)
  EnumLimit_536871516 = (when declared(EnumLimit):
    when ownSizeof(EnumLimit) != ownSizeof(EnumLimit_536871515):
      static :
    ...
    EnumLimit_536871515)
  EnumTargetEnv_536871546 = (when declared(EnumTargetEnv):
    when ownSizeof(EnumTargetEnv) != ownSizeof(EnumTargetEnv_536871545):
      static :
        warning("Declaration of " & "EnumTargetEnv" &
            " exists but with different size")
    EnumTargetEnv
  else:
    EnumTargetEnv_536871545)
  EnumCompilationStatus_536871550 = (when declared(EnumCompilationStatus):
    when ownSizeof(EnumCompilationStatus) != ownSizeof(EnumCompilationStatus_536871549):
      static :
        warning("Declaration of " & "EnumCompilationStatus" &
            " exists but with different size")
    EnumCompilationStatus
  else:
    EnumCompilationStatus_536871549)
  StructIncludeResult_536871528 = (when declared(StructIncludeResult):
    when ownSizeof(StructIncludeResult) != ownSizeof(StructIncludeResult_536871527):
      static :
        warning("Declaration of " & "StructIncludeResult" &
            " exists but with different size")
    StructIncludeResult
  else:
    StructIncludeResult_536871527)
  EnumSpirvVersion_536871548 = (when declared(EnumSpirvVersion):
    when ownSizeof(EnumSpirvVersion) != ownSizeof(EnumSpirvVersion_536871547):
      static :
        warning("Declaration of " & "EnumSpirvVersion" &
            " exists but with different size")
    EnumSpirvVersion
  else:
    EnumSpirvVersion_536871547)
  EnumSourceLanguage_536871500 = (when declared(EnumSourceLanguage):
    when ownSizeof(EnumSourceLanguage) != ownSizeof(EnumSourceLanguage_536871498):
      static :
        warning("Declaration of " & "EnumSourceLanguage" &
            " exists but with different size")
    EnumSourceLanguage
  else:
    EnumSourceLanguage_536871498)
  CompileOptionsT_536871526 = (when declared(CompileOptionsT):
    when ownSizeof(CompileOptionsT) != ownSizeof(CompileOptionsT_536871525):
      static :
        warning("Declaration of " & "CompileOptionsT" &
            " exists but with different size")
    CompileOptionsT
  else:
    CompileOptionsT_536871525)
  TargetEnv_536871538 = (when declared(TargetEnv):
    when ownSizeof(TargetEnv) != ownSizeof(TargetEnv_536871537):
      static :
    ...
    TargetEnv_536871537)
  SpirvVersion_536871540 = (when declared(SpirvVersion):
    when ownSizeof(SpirvVersion) != ownSizeof(SpirvVersion_536871539):
      static :
        warning("Declaration of " & "SpirvVersion" &
            " exists but with different size")
    SpirvVersion
  else:
    SpirvVersion_536871539)
  Profile_536871510 = (when declared(Profile):
    when ownSizeof(Profile) != ownSizeof(Profile_536871509):
      static :
    ...
    Profile_536871509)
  ShaderKind_536871506 = (when declared(ShaderKind):
    when ownSizeof(ShaderKind) != ownSizeof(ShaderKind_536871505):
      static :
        warning("Declaration of " & "ShaderKind" &
            " exists but with different size")
    ShaderKind
  else:
    ShaderKind_536871505)
  IncludeResult_536871530 = (when declared(IncludeResult):
    when ownSizeof(IncludeResult) != ownSizeof(IncludeResult_536871529):
      static :
        warning("Declaration of " & "IncludeResult" &
            " exists but with different size")
    IncludeResult
  else:
    IncludeResult_536871529)
  EnumUniformKind_536871520 = (when declared(EnumUniformKind):
    when ownSizeof(EnumUniformKind) != ownSizeof(EnumUniformKind_536871519):
      static :
        warning("Declaration of " & "EnumUniformKind" &
            " exists but with different size")
    EnumUniformKind
  else:
    EnumUniformKind_536871519)
  OptimizationLevel_536871514 = (when declared(OptimizationLevel):
    when ownSizeof(OptimizationLevel) != ownSizeof(OptimizationLevel_536871513):
      static :
        warning("Declaration of " & "OptimizationLevel" &
            " exists but with different size")
    OptimizationLevel
  else:
    OptimizationLevel_536871513)
  CompilationResultT_536871542 = (when declared(CompilationResultT):
    when ownSizeof(CompilationResultT) != ownSizeof(CompilationResultT_536871541):
      static :
        warning("Declaration of " & "CompilationResultT" &
            " exists but with different size")
    CompilationResultT
  else:
    CompilationResultT_536871541)
  EnumProfile_536871508 = (when declared(EnumProfile):
    when ownSizeof(EnumProfile) != ownSizeof(EnumProfile_536871507):
      static :
        warning("Declaration of " & "EnumProfile" &
            " exists but with different size")
    EnumProfile
  else:
    EnumProfile_536871507)
  EnumShaderKind_536871504 = (when declared(EnumShaderKind):
    when ownSizeof(EnumShaderKind) != ownSizeof(EnumShaderKind_536871503):
      static :
        warning("Declaration of " & "EnumShaderKind" &
            " exists but with different size")
    EnumShaderKind
  else:
    EnumShaderKind_536871503)
when not declared(Limit):
  type
    Limit* = Limit_536871517
else:
  static :
    hint("Declaration of " & "Limit" & " already exists, not redeclaring")
when not declared(CompilerT):
  type
    CompilerT* = CompilerT_536871523
else:
  static :
    hint("Declaration of " & "CompilerT" & " already exists, not redeclaring")
when not declared(CompilationStatus):
  type
    CompilationStatus* = CompilationStatus_536871543
else:
  static :
...
when not declared(EnumOptimizationLevel):
  type
    EnumOptimizationLevel* = EnumOptimizationLevel_536871511
else:
  static :
...
when not declared(IncludeResultReleaseFn):
  type
    IncludeResultReleaseFn* = IncludeResultReleaseFn_536871535
else:
  static :
...
when not declared(SourceLanguage):
  type
    SourceLanguage* = SourceLanguage_536871501
else:
  static :
...
when not declared(EnumIncludeType):
  type
    EnumIncludeType* = EnumIncludeType_536871531
else:
  static :
...
when not declared(EnumCompilationStatus):
  type
    EnumCompilationStatus* = EnumCompilationStatus_536871549
else:
  static :
...
when not declared(StructIncludeResult):
  type
    StructIncludeResult* = StructIncludeResult_536871527
else:
  static :
...
when not declared(EnumSpirvVersion):
  type
    EnumSpirvVersion* = EnumSpirvVersion_536871547
else:
  static :
...
when not declared(EnumSourceLanguage):
  type
    EnumSourceLanguage* = EnumSourceLanguage_536871498
else:
  static :
...
when not declared(CompileOptionsT):
  type
    CompileOptionsT* = CompileOptionsT_536871525
else:
  static :
...
when not declared(EnumUniformKind):
  type
    EnumUniformKind* = EnumUniformKind_536871519
else:
  static :
...
when not declared(OptimizationLevel):
  type
    OptimizationLevel* = OptimizationLevel_536871513
else:
  static :
...
when not declared(CompilationResultT):
  type
    CompilationResultT* = CompilationResultT_536871541
else:
  static :
...
when not declared(compilerRelease):
  proc compilerRelease*(a0: CompilerT_536871524): void {.cdecl,
...
when not declared(compileOptionsInitialize):
  proc compileOptionsInitialize*(): CompileOptionsT_536871526 {.cdecl,
...
when not declared(compileOptionsClone):
  proc compileOptionsClone*(options: CompileOptionsT_536871526): CompileOptionsT_536871526 {.
...
when not declared(compileOptionsRelease):
  proc compileOptionsRelease*(options: CompileOptionsT_536871526): void {.cdecl,
...
when not declared(compileOptionsAddMacroDefinition):
  proc compileOptionsAddMacroDefinition*(options: CompileOptionsT_536871526;
...
when not declared(compileOptionsSetSourceLanguage):
  proc compileOptionsSetSourceLanguage*(options: CompileOptionsT_536871526;
                                        lang: SourceLanguage_536871502): void {.
...
when not declared(compileOptionsSetGenerateDebugInfo):
  proc compileOptionsSetGenerateDebugInfo*(options: CompileOptionsT_536871526): void {.
...
when not declared(compileOptionsSetOptimizationLevel):
  proc compileOptionsSetOptimizationLevel*(options: CompileOptionsT_536871526;
      level: OptimizationLevel_536871514): void {.cdecl,
...
when not declared(compileOptionsSetForcedVersionProfile):
  proc compileOptionsSetForcedVersionProfile*(options: CompileOptionsT_536871526;
      version: cint; profile: Profile_536871510): void {.cdecl,
...
when not declared(compileOptionsSetIncludeCallbacks):
  proc compileOptionsSetIncludeCallbacks*(options: CompileOptionsT_536871526;
      resolver: IncludeResolveFn_536871534;
      resultReleaser: IncludeResultReleaseFn_536871536; userData: pointer): void {.
...
when not declared(compileOptionsSetSuppressWarnings):
  proc compileOptionsSetSuppressWarnings*(options: CompileOptionsT_536871526): void {.
...
when not declared(compileOptionsSetTargetEnv):
  proc compileOptionsSetTargetEnv*(options: CompileOptionsT_536871526;
                                   target: TargetEnv_536871538; version: cint): void {.
...
when not declared(compileOptionsSetTargetSpirv):
  proc compileOptionsSetTargetSpirv*(options: CompileOptionsT_536871526;
                                     version: SpirvVersion_536871540): void {.
...
when not declared(compileOptionsSetWarningsAsErrors):
  proc compileOptionsSetWarningsAsErrors*(options: CompileOptionsT_536871526): void {.
...
when not declared(compileOptionsSetLimit):
  proc compileOptionsSetLimit*(options: CompileOptionsT_536871526; limit: Limit_536871518;
...
when not declared(compileOptionsSetAutoBindUniforms):
  proc compileOptionsSetAutoBindUniforms*(options: CompileOptionsT_536871526;
...
when not declared(compileOptionsSetAutoCombinedImageSampler):
  proc compileOptionsSetAutoCombinedImageSampler*(options: CompileOptionsT_536871526;
...
when not declared(compileOptionsSetHlslIoMapping):
  proc compileOptionsSetHlslIoMapping*(options: CompileOptionsT_536871526;
...
when not declared(compileOptionsSetHlslOffsets):
  proc compileOptionsSetHlslOffsets*(options: CompileOptionsT_536871526;
...
when not declared(compileOptionsSetBindingBase):
  proc compileOptionsSetBindingBase*(options: CompileOptionsT_536871526;
                                     kind: UniformKind_536871522; base: cint): void {.
...
when not declared(compileOptionsSetBindingBaseForStage):
  proc compileOptionsSetBindingBaseForStage*(options: CompileOptionsT_536871526;
      shaderKind: ShaderKind_536871506; kind: UniformKind_536871522; base: cint): void {.
...
when not declared(compileOptionsSetPreserveBindings):
  proc compileOptionsSetPreserveBindings*(options: CompileOptionsT_536871526;
...
when not declared(compileOptionsSetAutoMapLocations):
  proc compileOptionsSetAutoMapLocations*(options: CompileOptionsT_536871526;
...
when not declared(compileOptionsSetHlslRegisterSetAndBindingForStage):
  proc compileOptionsSetHlslRegisterSetAndBindingForStage*(
      options: CompileOptionsT_536871526; shaderKind: ShaderKind_536871506;
...
when not declared(compileOptionsSetHlslRegisterSetAndBinding):
  proc compileOptionsSetHlslRegisterSetAndBinding*(options: CompileOptionsT_536871526;
...
when not declared(compileOptionsSetHlslFunctionality1):
  proc compileOptionsSetHlslFunctionality1*(options: CompileOptionsT_536871526;
...
when not declared(compileOptionsSetHlsl16bitTypes):
  proc compileOptionsSetHlsl16bitTypes*(options: CompileOptionsT_536871526;
...
when not declared(compileOptionsSetVulkanRulesRelaxed):
  proc compileOptionsSetVulkanRulesRelaxed*(options: CompileOptionsT_536871526;
...
when not declared(compileOptionsSetInvertY):
  proc compileOptionsSetInvertY*(options: CompileOptionsT_536871526;
                                 enable: bool): void {.cdecl,
...
when not declared(compileOptionsSetNanClamp):
  proc compileOptionsSetNanClamp*(options: CompileOptionsT_536871526;
                                  enable: bool): void {.cdecl,
...
when not declared(compileIntoSpv):
  proc compileIntoSpv*(compiler: CompilerT_536871524; sourceText: cstring;
                       sourceTextSize: csize_t; shaderKind: ShaderKind_536871506;
                       inputFileName: cstring; entryPointName: cstring;
                       additionalOptions: CompileOptionsT_536871526): CompilationResultT_536871542 {.
...
when not declared(compileIntoSpvAssembly):
  proc compileIntoSpvAssembly*(compiler: CompilerT_536871524;
                               sourceText: cstring; sourceTextSize: csize_t;
                               shaderKind: ShaderKind_536871506;
                               inputFileName: cstring; entryPointName: cstring;
                               additionalOptions: CompileOptionsT_536871526): CompilationResultT_536871542 {.
...
when not declared(compileIntoPreprocessedText):
  proc compileIntoPreprocessedText*(compiler: CompilerT_536871524;
                                    sourceText: cstring;
...
when not declared(assembleIntoSpv):
  proc assembleIntoSpv*(compiler: CompilerT_536871524; sourceAssembly: cstring;
...
when not declared(resultRelease):
  proc resultRelease*(result: CompilationResultT_536871542): void {.cdecl,
...
when not declared(resultGetLength):
  proc resultGetLength*(result: CompilationResultT_536871542): csize_t {.cdecl,
...
when not declared(resultGetNumWarnings):
  proc resultGetNumWarnings*(result: CompilationResultT_536871542): csize_t {.
...
when not declared(resultGetNumErrors):
  proc resultGetNumErrors*(result: CompilationResultT_536871542): csize_t {.
...
when not declared(resultGetCompilationStatus):
  proc resultGetCompilationStatus*(a0: CompilationResultT_536871542): CompilationStatus_536871544 {.
...
when not declared(resultGetBytes):
  proc resultGetBytes*(result: CompilationResultT_536871542): cstring {.cdecl,
...
when not declared(resultGetErrorMessage):
  proc resultGetErrorMessage*(result: CompilationResultT_536871542): cstring {.
...
when not declared(parseVersionProfile):
  proc parseVersionProfile*(str: cstring; version: ptr cint;
                            profile: ptr Profile_536871510): bool {.cdecl,
